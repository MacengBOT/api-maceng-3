...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw ajaa di wa.me/6285161602919'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/6285161602919 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'Maceng'+'BOT';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'MacengKey') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'MacengKey') return res.json(loghandler.invalidKey)
